    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typecontrat', models.CharField(choices=[('CDD', 'Contrat à durée déterminé'), ('CDI', 'Contrat à durée indéterminé')], max_length=40)),
                ...
                ('employe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contrat', to='employe.employe')),
            ],
        ),
    ]
